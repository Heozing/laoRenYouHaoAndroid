...
import 'package:flutter_OldManFriendly/core/widget/web_view_page.dart';
import 'package:flutter_OldManFriendly/init/splash.dart';
...
class RouteMap {
  static List<GetPage> getPages = [
    ...
    //GetPage(name: '/tab-meishi', page: () => TabMeiShiPage()),
  ];
